...
# Dynamically add venue status field
from django import forms
from .models import Venue  # adjust import path
...
def make_active(modeladmin, request, queryset):
    ...
    modeladmin.message_user(request, f'{venue_count} venues activated. {turf_count} turfs updated.')
...
def make_inactive(modeladmin, request, queryset):
    ...
    modeladmin.message_user(request, f'{venue_count} venues marked as inactive. {turf_count} turfs updated.')
...
class VenueVerificationAdmin(UnfoldModelAdmin):
    ...
    fieldsets = (
        ...
        # ('Venue Status', {'fields': ('venue_status_field',)}),  # editable venue status
    ...
    def approve_verification(self, request, queryset):
        ...
        for verification in queryset:
            ...
            updated += 1
        self.message_user(request, f'{updated} venues verified, activated, and turfs updated.')
    approve_verification.short_description = "Approve verification & activate venue + turfs"
    ...
    def reject_verification(self, request, queryset):
        ...
        for verification in queryset.exclude(verified=True):
            ...
            updated += 1
        self.message_user(request, f'{updated} venues rejected and marked inactive with turfs.')
    reject_verification.short_description = "Reject verification & deactivate venue + turfs"
